...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    """Test `help all` command message"""
    def test_help_all(self):
        help_msg = ("Usage: all or all <class> or <class>.all()\n"
                    "        Display all instances of a specified class.\n"
                    "        If no class is specified, displays all the"
                    " instance of the objects.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help all"))
            self.assertEqual(help_msg, output.getvalue().strip())

    """Test `help create` command message"""
    def test_help_create(self):
        help_msg = ("Usage: create <class>\n"
                    "        Create a new class instance and prints id of"
                    " created instance.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help create"))
            self.assertEqual(help_msg, output.getvalue().strip())

    """Test `help EOF` command message"""
    ...
    """Test `help show` command message"""
    ...
    """Test `help destroy` command message"""
    ...
    """Test `help count` command message"""
    ...
    """Test `help update` command message"""
    def test_help_update(self):
        help_msg = ("Usage: update <class> <id> <attribute_name>"
                    " <attribute_value> or\n"
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Test for testing the `quit` command"""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Test for testing the `show` command"""
    ...
    def test_show_missing_class(self):
        ouput_message = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("show"))
            self.assertEqual(ouput_message, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(".show()"))
            self.assertEqual(ouput_message, output.getvalue().strip())

    def test_show_invalid_class(self):
        ouput_message = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_missing_id_space_notation(self):
        ouput_message = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_no_instance_found_space_notation(self):
        ouput_message = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_count(unittest.TestCase):
    """Test for testing the `all` command"""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Test for testing the `create` command"""
    ...
    def test_create_invalid_syntax(self):
        ouput_message = "*** Unknown syntax: MyModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("MyModel.create()"))
            self.assertEqual(ouput_message, output.getvalue().strip())
        ouput_message = "*** Unknown syntax: BaseModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_update(unittest.TestCase):
    """Test for testing the `update` command"""
    ...
    def test_update_missing_attr_name_space_notation(self):
        ouput_message = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
